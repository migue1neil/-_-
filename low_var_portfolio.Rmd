...
<font face="微軟正黑體"> <font size = 4> 我的Github :
<https://github.com/migue1neil/TW-telecompany-portfolio> <br>
...
在文章中利用，股價數據去計算波動性以及季線之方式進行定期換股，模擬出波動相對市場較低，報酬相對較佳之投資組合。
```{r ,echo = FALSE}
knitr::include_graphics("C:/Users/Neil/Documents/git-repos/backtest_in_R/quant/低波動動能投資組合/20130102_20220601低波動季線投組報酬.png")
```
在上圖中，我們可以看到，用兩個指標所設計出來的投資組合與市場報酬的比較。
